...
class MyFrame(wx.Frame):
 ...
 def __init__(self):
               ...
               panel = wx.Panel(self, -1) # панель на которой распалагаются элементы управления,
               # Frame - это просто рамка, -1 это индификатор через который панель и фрейм соеденяются
